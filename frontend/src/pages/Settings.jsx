  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      ...
      <div className="bg-slate-900/50 p-6 rounded-xl border border-slate-800">
              ...
              {MOCK_CAMERAS.map((camera) => (
                <tr key={camera.id} className="border-b border-slate-800 hover:bg-slate-800/40">
                  ...
                  <td className="px-6 py-4">
                    {camera.specificLocation}, {camera.district}
                  </td>
        ...
        <h4 className="text-lg font-semibold text-white mb-4 border-t border-slate-700 pt-6">
          Add New Camera
        </h4>

        <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label htmlFor="camId" className="block text-sm font-medium text-slate-400 mb-1">
              Camera ID
            </label>
            <input
              id="camId"
          ...
          <div className="md:col-span-2">
            <label htmlFor="rtspUrl" className="block text-sm font-medium text-slate-400 mb-1">
              RTSP URL
            </label>
            <input
              id="rtspUrl"
              type="text"
              placeholder="rtsp://..."
              className="w-full bg-slate-800 border border-slate-700 rounded-lg py-2 px-3 font-mono focus:outline-none focus:ring-2 focus:ring-emerald-500"
            />
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <textarea
              id="description"
              rows="3"
              placeholder="Notes about the camera placement or view."
              className="w-full bg-slate-800 border border-slate-700 rounded-lg py-2 px-3 focus:outline-none focus:ring-2 focus:ring-emerald-500"
            ></textarea>
          </div>
          ...
          <div className="md:col-span-2 flex justify-end">
            <button
              type="submit"
              className="bg-emerald-600 hover:bg-emerald-500 text-white font-bold py-2 px-6 rounded-lg transition-all"
            >
              Add Camera
            </button>
          </div>
