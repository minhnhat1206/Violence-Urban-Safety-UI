...
// } from 'recharts';
// import { ShieldAlert, Activity, Video } from 'lucide-react';
...
const Analytics = () => {
  // 1) snapshot + kiosk (quick)
  const snapshotUrl =
    "http://localhost:3001/dashboard/snapshot/EjO7sJKz7SnlO4o5YyXb7HVi8INLPaft?kiosk";

  // 2) preferred: embed single panel using d-solo
  const soloUrl =
    "http://localhost:3001/dashboard/snapshot/EjO7sJKz7SnlO4o5YyXb7HVi8INLPaft?kiosk";
  ...
  return (
    <div className="bg-slate-900/50 p-6 rounded-xl border border-slate-800 shadow-lg">
      <div className="h-[800px] w-full">
        <iframe
          src={soloUrl} // thử chuyển sang snapshotUrl nếu cần
          width="100%"
          height="100%"
          frameBorder="0"
          allowFullScreen
